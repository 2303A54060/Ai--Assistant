#TASK 1
#generate a documentaion for the functions def find_max(numbers),return max(numbers) with docstring documentation.
...
#generate a documentaion for the function  def find_max(numbers),return max(numbers) with inline comments.
def find_max(numbers):
    ...
    return max(numbers)
#generate  a documentaion for the function  def find_max(numbers),return max(numbers) with google style documentation.
def find_max(numbers):
    """
...
#TASK 2:
#generate a documentation for  Python function def login(user, password, credentials) ,return credentials.get(user) == password with docstring documentation.
...
#generate a documentation for  Python function def login(user, password, credentials) ,return credentials.get(user) == password with inline comments.
def login(user, password, credentials):
    # This function checks if the provided user credentials are valid.
    ...
    return credentials.get(user) == password
#generate a documentation for  Python function def login(user, password, credentials) ,return credentials.get(user) == password with google style documentation.
def login(user, password, credentials):
    """
